...
import profilePic from '../assets/heroimage.jpg'
        ...
        <div className="border-b border-neutral-900 pb-4  lg:mb-35">
            <div className="flex flex-wrap">
                ...
                <div className="flex flex-col items-center lg:items-start">
                    <motion.h1 variants={container(0)} initial="hidden" animate={"visible"} className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl'>Bolormaa Enkhbat</motion.h1>
                ...
                <div className="w-full lg:w-1/2 lg:p-8">
                    <div className="flex justify-center">
                        ...
                        src={profilePic}  alt="alt kevin rush" />
                    </div>
                </div>
            </div>
        </div>
